    ...
    (function() {
      ...
      var splitList = function(editor, list, li) {
        var removeAndKeepBookmarks = function(targetNode) {
          global$2.each(bookmarks, function(node2) {
            targetNode.parentNode.insertBefore(node2, li.parentNode);
          });
      ...
      var getSelectedTextBlocks = function(editor, rng, root) {
        ...
        global$2.each(siblings, function(node2) {
          ...
          if (global.isBookmarkNode(node2)) {
      ...
      var mergeLiElements = function(dom, fromElm, toElm) {
        ...
        var contains$12 = contains(SugarElement.fromDom(toElm), SugarElement.fromDom(fromElm));
